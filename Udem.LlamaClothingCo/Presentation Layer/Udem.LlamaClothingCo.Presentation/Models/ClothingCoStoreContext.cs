...
namespace ClothingCoStore.Models
{
    public class ClothingCoStoreContext : DbContext
    {
        ...
        // 
        // System.Data.Entity.Database.SetInitializer(new System.Data.Entity.DropCreateDatabaseIfModelChanges<ClothingCoStore.Models.ClothingCoStoreContext>());

        public ClothingCoStoreContext() : base("name=ClothingCoStoreContext")
        {
        }
